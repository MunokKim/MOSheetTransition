...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.description      = 'By using `UIViewControllerInteractiveTransitioning` and `UIViewPropertyAnimator`, interactive transitions are implemented in a form similar to `UIModalPresentationStyle`\'s `.pageSheet`.'
